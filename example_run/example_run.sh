...
# Assuming that the receptor chain is chain A
...
# create a list of the input structures for refinement
ls ???_????_*_*_0001.pdb > input_list

# Run Rosetta FlexPepDock refinement
